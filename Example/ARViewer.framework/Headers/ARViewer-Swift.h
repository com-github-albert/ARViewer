...
SWIFT_CLASS("_TtC8ARViewer6ARView")
@interface ARView : SCNView
@property (nonatomic, strong) UIImage * _Nullable panoramaTexture;
@property (nonatomic, strong) AVPlayer * _Nullable panoramaVideoPlayer;
...
@interface ARView (SWIFT_EXTENSION(ARViewer))
@end


@interface CMDeviceMotion (SWIFT_EXTENSION(ARViewer))
@end

@class AVCaptureVideoPreviewLayer;
@class AVCaptureSession;

SWIFT_CLASS("_TtC8ARViewer13CameraPreview")
